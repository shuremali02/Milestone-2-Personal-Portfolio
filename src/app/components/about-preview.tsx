      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <Reveal>
          <TiltCard max={4} className="rounded-3xl">
            <div className="glass rounded-3xl p-8 md:p-12 grid grid-cols-1 md:grid-cols-[auto,1fr] gap-8 items-center">
              <Image
                src="https://res.cloudinary.com/dd4xvwf8d/image/upload/v1755281625/c9cc0a17-e6c2-44e4-aab5-0a2482786f3f_blwhw3.jpg"
                alt="Syed Shurem Ali"
                width={140}
                height={140}
                className="rounded-2xl border-2 border-primary/40 shadow-lg mx-auto md:mx-0"
              />
              <div className="text-center md:text-left">
                ...
                <p className="text-textMain leading-relaxed mb-5 max-w-2xl">
                  ...
                  <span className="text-primary font-semibold"><ExperienceCounter /> years</span>{" "}
                  of hands-on experience — building web apps with Next.js &amp;
                  TypeScript, Android apps with Flutter &amp; Dart, and deploying
                  them to production on VPS and Hostinger.
                </p>
